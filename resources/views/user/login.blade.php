        ...
        <div class="relative w-full max-w-md">
            ...
            <div class="bg-black/70 backdrop-blur-xl border border-gray-800 rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-red-600/20 to-red-600/10 border-b border-gray-800 p-8 text-center">
                    ...
                    <p class="text-gray-400 text-sm">Sign in to continue to MovieFlix</p>
                </div>
                ...
                <div class="p-8">
                    ...
                    {{-- Error Message --}}
                    @if ($errors->any())
                    <div class="bg-red-600/10 border border-red-600/50 text-red-400 p-4 rounded-lg mb-6 flex items-start gap-3">
                    ...
                    <div class="relative my-8">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-4 bg-black/50 text-gray-500 backdrop-blur-xl">New to MovieFlix?</span>
                        </div>
                    </div>

                    {{-- Register Link --}}
                    <a href="{{ route('user.register') }}" class="block w-full bg-gray-900 hover:bg-gray-800 border border-gray-700 hover:border-gray-600 text-white text-center font-semibold py-3.5 rounded-lg transition">
                        Create New Account
                    </a>
